...
build-975928961:
	@$(MAKE) --no-print-directory -Onone -f subdir_rules.mk build-975928961-inproc

build-975928961-inproc: ../rtos.cfg
	@echo 'Building file: "$<"'
...
configPkg/linker.cmd: build-975928961 ../rtos.cfg
configPkg/compiler.opt: build-975928961
configPkg/: build-975928961
